...
- Public mail TCP ports are DNATed through a direct WireGuard tunnel. The office mail services retain the original client IP.
...
- Tailscale is reserved for administration and is not part of the mail data path.
